...
7. 在 **Authentication (Database Native)** 部分，输入你的 **Username** 和 **Password**。示例如下：
    ...
    ![配置 TiDB Cloud Serverless 连接参数](/media/develop/dbeaver-connection-settings-serverless.jpg)
...
5. 将相应的连接字符串复制粘贴到 DBeaver 连接面板中。DBeaver 字段与 TiDB Cloud Dedicated 连接字符串的映射关系如下：
    ...
    ![配置 TiDB Cloud Dedicated 连接参数](/media/develop/dbeaver-connection-settings-dedicated.jpg)
...
2. 配置以下连接参数：
    ...
    ![配置 TiDB 自建集群连接参数](/media/develop/dbeaver-connection-settings-self-hosted.jpg)
