...
> **注意：**
>
> 本教程兼容 {{{ .starter }}}, {{{ .essential }}}, TiDB Cloud 专属集群，以及自托管 TiDB。
...
7. 在 **Authentication (Database Native)** 部分，输入你的 **Username** 和 **Password**。示例如下：
    ...
    ![为 {{{ .starter }}} 配置连接参数](/media/develop/dbeaver-connection-settings-serverless.jpg)
...
3. 在连接对话框中，从 **Connection Type** 下拉列表选择 **Public**，然后点击 **CA cert** 下载 CA 证书。
    ...
    除了 **Public** 连接类型，TiDB Cloud Dedicated 还支持 **Private Endpoint** 和 **VPC Peering** 连接类型。更多信息请参见 [连接到你的 TiDB Cloud 专属集群](https://docs.pingcap.com/tidbcloud/connect-to-tidb-cluster)。
...
2. 配置以下连接参数：
    ...
    ![为 TiDB 自托管配置连接参数](/media/develop/dbeaver-connection-settings-self-hosted.jpg)
