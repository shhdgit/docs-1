...
7. 点击 **SSL** 标签页，勾选 **Use SSL**、**Use authentication** 和 **Verify server certificate against CA** 复选框。然后，将 TiDB Cloud 连接对话框中的 `CA` 文件选择到 **CA Certificate** 字段中。
...
7. 点击 **SSL** 标签页，勾选 **Use SSL**、**Use authentication** 和 **Verify server certificate against CA** 复选框。然后，将第 4 步下载的 CA 文件选择到 **CA Certificate** 字段中。
