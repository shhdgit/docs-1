...
5. 启动 VS Code，在导航栏选择 **SQLTools** 扩展。在 **CONNECTIONS** 区域，点击 **Add New Connection**，选择 **TiDB** 作为数据库驱动。
...
6. 在设置面板中，配置以下连接参数：
    ...
    - **Connection group**：（可选）为该连接组起一个有意义的名称。具有相同组名的连接会被归为一组。
...
4. 启动 VS Code，在导航栏选择 **SQLTools** 扩展。在 **CONNECTIONS** 区域，点击 **Add New Connection**，选择 **TiDB** 作为数据库驱动。
...
1. 启动 VS Code，在导航栏选择 **SQLTools** 扩展。在 **CONNECTIONS** 区域，点击 **Add New Connection**，选择 **TiDB** 作为数据库驱动。
