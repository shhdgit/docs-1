...
TiDB 是兼容 MySQL 的数据库，[GORM](https://gorm.io/index.html) 是 Golang 领域流行的开源 ORM 框架。GORM 支持 TiDB 的特性，如 `AUTO_RANDOM`，并且[将 TiDB 作为默认数据库选项进行支持](https://gorm.io/docs/connecting_to_the_database.html#TiDB)。
