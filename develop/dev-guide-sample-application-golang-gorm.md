...
- 通过 [GORM 的文档](https://gorm.io/docs/index.html) 和 [GORM 中的 TiDB 部分](https://gorm.io/docs/connecting_to_the_database.html#TiDB) 了解更多 GORM 的用法。
- 通过 [开发者指南](https://github.com/tidb-samples/tidb-golang-gorm-quickstart) 中的章节学习 TiDB 应用开发的最佳实践，例如 [Insert data](/develop/dev-guide-insert-data.md)、[Update data](/develop/dev-guide-update-data.md)、[Delete data](/develop/dev-guide-delete-data.md)、[Single table reading](/develop/dev-guide-get-data-from-single-table.md)、[Transactions](/develop/dev-guide-transaction-overview.md) 和 [SQL 性能优化](/develop/dev-guide-optimize-sql-overview.md)。
