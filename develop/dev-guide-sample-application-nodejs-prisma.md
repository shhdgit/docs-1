...
完整示例代码及运行方式请参见 [tidb-samples/tidb-nodejs-prisma-quickstart](https://github.com/tidb-samples/tidb-nodejs-prisma-quickstart) 仓库。
...
- [外键](https://docs.pingcap.com/tidb/stable/foreign-key) 是 TiDB v6.6.0 开始支持的功能，并在 v8.5.0 起正式可用。外键允许跨表引用相关数据，外键约束可确保相关数据的一致性。
