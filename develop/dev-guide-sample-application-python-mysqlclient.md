...
summary: 学习如何使用 mysqlclient 连接 TiDB。本教程提供了适用于 TiDB 的 Python 示例代码片段，演示如何使用 mysqlclient 进行操作。
---

# 使用 mysqlclient 连接 TiDB

TiDB 是兼容 MySQL 的数据库，[mysqlclient](https://github.com/PyMySQL/mysqlclient) 是 Python 领域流行的开源驱动。
