...
* `STATUS_ADDRESS`：HTTP API 的服务地址。部分 tikv-ctl、pd-ctl 或 tidb-ctl 的命令可能会使用该 API 及其地址。你也可以通过该地址获取更多集群信息。详细信息请参考 [TiDB HTTP API 文档](https://github.com/pingcap/tidb/blob/release-8.5/docs/tidb_http_api.md)。
