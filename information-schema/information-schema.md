...
> **注意：**
>
> 下列部分表仅在 TiDB 自建版中支持，在 TiDB Cloud 中不支持。要获取 TiDB Cloud 上不支持的系统表完整列表，请参见 [System tables](https://docs.pingcap.com/tidbcloud/limited-sql-features#system-tables)。
...
| [`MEMORY_USAGE_OPS_HISTORY`](/information-schema/information-schema-memory-usage-ops-history.md)    | 当前 TiDB 实例内存相关操作及执行依据的历史记录。 |
