...
- 追加のテストの後、TiCDC Changefeed 構成項目 [`case-sensitive`](/ticdc/ticdc-changefeed-config.md) のデフォルト値が `true` から `false` に変更されました。これにより、デフォルトで、TiCDC 構成ファイル内のテーブルおよびデータベース名は大文字と小文字を区別しません [#10047](https://github.com/pingcap/tiflow/issues/10047) @[sdojjy](https://github.com/sdojjy)
- TiCDC Changefeed には、次の新しい構成項目が導入されました:
  - [`sql-mode`](https://docs.pingcap.com/tidb/v7.1/ticdc-changefeed-config): TiCDC が DDL ステートメントを解析する際に使用する[SQL モード](https://docs.pingcap.com/tidb/v7.1/ticdc-ddl#sql-mode)を設定できます [#9876](https://github.com/pingcap/tiflow/issues/9876) @[asddongmen](https://github.com/asddongmen)
  - [`encoding-worker-num`](https://docs.pingcap.com/tidb/v7.1/ticdc-changefeed-config) および [`flush-worker-num`](https://docs.pingcap.com/tidb/v7.1/ticdc-changefeed-config): 異なるマシンの仕様に基づいて redo モジュールの異なる並行性パラメータを設定できます [#10048](https://github.com/pingcap/tiflow/issues/10048) @[CharlesCheung96](https://github.com/CharlesCheung96)
  - [`compression`](https://docs.pingcap.com/tidb/v7.1/ticdc-changefeed-config): redo ログファイルの圧縮動作を構成できます [#10176](https://github.com/pingcap/tiflow/issues/10176) @[sdojjy](https://github.com/sdojjy)
  - [`sink.cloud-storage-config`](https://docs.pingcap.com/tidb/v7.1/ticdc-changefeed-config): オブジェクトストレージにデータをレプリケートする際の歴史データの自動クリーンアップを設定できます [#10109](https://github.com/pingcap/tiflow/issues/10109) @[CharlesCheung96](https://github.com/CharlesCheung96)
...
- PD
  ...
  - リソース制御クライアントの構成取得方法を強化し、最新の構成を動的に取得できるようにしました [#7043](https://github.com/tikv/pd/issues/7043) @[nolouch](https://github.com/nolouch)

- ツール

  - バックアップ＆リストア (BR)

    - スナップショットのリカバリ中にリージョンのスキャッタの自動リトライを有効にし、タイムアウトの失敗やリージョンのスキャッタのキャンセルが発生した場合 [#47236](https://github.com/pingcap/tidb/issues/47236) @[Leavrth](https://github.com/Leavrth)
    - スナップショットバックアップのリストア中に、特定のネットワークエラーが発生した場合に BR がリトライを行います [#48528](https://github.com/pingcap/tidb/issues/48528) @[Leavrth](https://github.com/Leavrth)
    - `delete range` シナリオでの Point-In-Time Recovery (PITR) のための新しい統合テストを導入し、PITR の安定性を向上させました  [#47738](https://github.com/pingcap/tidb/issues/47738) @[Leavrth](https://github.com/Leavrth)

  - TiCDC

    - TiCDC ノードが TiDB にデータをレプリケートする際のメモリ消費を最適化しました [#9935](https://github.com/pingcap/tiflow/issues/9935) @[3AceShowHand](https://github.com/3AceShowHand)
    - 一部のアラームルールを最適化しました [#9266](https://github.com/pingcap/tiflow/issues/9266) @[asddongmen](https://github.com/asddongmen)
    - S3 へのデータの並列書き込みや lz4 圧縮アルゴリズムの採用を含む redo ログのパフォーマンスを最適化しました [#10176](https://github.com/pingcap/tiflow/issues/10176) [#10226](https://github.com/pingcap/tiflow/issues/10226) @[sdojjy](https://github.com/sdojjy)
    - オブジェクトストレージにデータをレプリケートする際の TiCDC のパフォーマンスを向上させるために並列処理を増やしました [#10098](https://github.com/pingcap/tiflow/issues/10098) @[CharlesCheung96](https://github.com/CharlesCheung96)
    - TiCDC の増分スキャンが上流の TiKV に与える影響を軽減しました [#11390](https://github.com/tikv/tikv/issues/11390) @[hicqu](https://github.com/hicqu)
    - `sink-uri` 構成で `content-compatible=true` を設定することで、TiCDC Canal-JSON コンテンツ形式を[公式 Canal 出力のコンテンツ形式と互換性があるようにサポート](https://docs.pingcap.com/tidb/v6.5/ticdc-canal-json#compatibility-with-the-official-canal)しました [#10106](https://github.com/pingcap/tiflow/issues/10106) @[3AceShowHand](https://github.com/3AceShowHand)

  - TiDB Lightning

    - PD リーダーの変更による `GetTS` の失敗に対するリトライメカニズムを追加しました [#45301](https://github.com/pingcap/tidb/issues/45301) @[lance6716](https://github.com/lance6716)
