...
summary: TiDB 数据库中 `ADMIN ALTER DDL JOBS` 的用法概述。
---
...
> **Note:**
>
> 目前，该功能不支持在 [TiDB Cloud Serverless](https://docs.pingcap.com/tidbcloud/select-cluster-tier#tidb-cloud-serverless) 和 [TiDB Cloud Essential](https://docs.pingcap.com/tidbcloud/select-cluster-tier#essential) 集群上使用。
...
要查看指定 DDL 任务的当前参数值，你可以执行 `ADMIN SHOW DDL JOBS`。结果会显示在 `COMMENTS` 列中：
