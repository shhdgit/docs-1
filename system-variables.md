...
### password_reuse_interval <span class="version-mark">New in v6.5.0</span> {#password-reuse-interval-span-class-version-mark-new-in-v6-5-0-span}
...
### tidb_allow_tiflash_cop <span class="version-mark">New in v7.3.0</span> {#tidb-allow-tiflash-cop-span-class-version-mark-new-in-v7-3-0-span}
...
### tidb_analyze_skip_column_types <span class="version-mark">New in v7.2.0</span> {#tidb-analyze-skip-column-types-span-class-version-mark-new-in-v7-2-0-span}
...
### tidb_dml_type <span class="version-mark">New in v8.0.0</span> {#tidb-dml-type-span-class-version-mark-new-in-v8-0-0-span}
...
### tidb_enable_auto_analyze_priority_queue <span class="version-mark">New in v8.0.0</span> {#tidb-enable-auto-analyze-priority-queue-span-class-version-mark-new-in-v8-0-0-span}
...
### tidb_enable_check_constraint <span class="version-mark">New in v7.2.0</span> {#tidb-enable-check-constraint-span-class-version-mark-new-in-v7-2-0-span}
...
### tidb_enable_fast_table_check <span class="version-mark">New in v7.2.0</span> {#tidb-enable-fast-table-check-span-class-version-mark-new-in-v7-2-0-span}
...
### tidb_enable_global_index <span class="version-mark">New in v7.6.0</span> {#tidb-enable-global-index-span-class-version-mark-new-in-v7-6-0-span}
...
### tidb_enable_lazy_cursor_fetch <span class="version-mark">New in v8.3.0</span> {#tidb-enable-lazy-cursor-fetch-span-class-version-mark-new-in-v8-3-0-span}
...
### tidb_enable_instance_plan_cache <span class="version-mark">New in v8.4.0</span> {#tidb-enable-instance-plan-cache-span-class-version-mark-new-in-v8-4-0-span}
...
### tidb_enable_parallel_hashagg_spill <span class="version-mark">New in v8.0.0</span> {#tidb-enable-parallel-hashagg-spill-span-class-version-mark-new-in-v8-0-0-span}
...
### tidb_enable_plan_cache_for_subquery <span class="version-mark">New in v7.0.0</span> {#tidb-enable-plan-cache-for-subquery-span-class-version-mark-new-in-v7-0-0-span}
...
### tidb_enable_resource_control <span class="version-mark">New in v6.6.0</span> {#tidb-enable-resource-control-span-class-version-mark-new-in-v6-6-0-span}
...
### tidb_enable_reuse_chunk <span class="version-mark">New in v6.4.0</span> {#tidb-enable-reuse-chunk-span-class-version-mark-new-in-v6-4-0-span}
...
### tidb_enable_shared_lock_promotion <span class="version-mark">New in v8.3.0</span> {#tidb-enable-shared-lock-promotion-span-class-version-mark-new-in-v8-3-0-span}
...
### tidb_enable_stats_owner <span class="version-mark">New in v8.4.0</span> {#tidb-enable-stats-owner-span-class-version-mark-new-in-v8-4-0-span}
...
### tidb_enable_telemetry <span class="version-mark">New in v4.0.2 and deprecated in v8.1.0</span> {#tidb-enable-telemetry-span-class-version-mark-new-in-v4-0-2-and-deprecated-in-v8-1-0-span}
...
### tidb_enable_tiflash_read_for_write_stmt <span class="version-mark">New in v6.3.0</span> {#tidb-enable-tiflash-read-for-write-stmt-span-class-version-mark-new-in-v6-3-0-span}
...
### tidb_enable_unsafe_substitute <span class="version-mark">New in v6.3.0</span> {#tidb-enable-unsafe-substitute-span-class-version-mark-new-in-v6-3-0-span}
...
### tidb_enable_vectorized_expression <span class="version-mark">New in v4.0</span> {#tidb-enable-vectorized-expression-span-class-version-mark-new-in-v4-0-span}
...
### <code>tidb_enable_row_level_checksum</code> <span class="version-mark">New in v7.1.0</span> {#code-tidb-enable-row-level-checksum-code-span-class-version-mark-new-in-v7-1-0-span}
...
### tidb_evolve_plan_task_end_time <span class="version-mark">New in v4.0</span> {#tidb-evolve-plan-task-end-time-span-class-version-mark-new-in-v4-0-span}
...
### tidb_expensive_txn_time_threshold <span class="version-mark">New in v7.2.0</span> {#tidb-expensive-txn-time-threshold-span-class-version-mark-new-in-v7-2-0-span}
...
### tidb_gc_max_wait_time <span class="version-mark">New in v6.1.0</span> {#tidb-gc-max-wait-time-span-class-version-mark-new-in-v6-1-0-span}
...
### tidb_pre_split_regions <span class="version-mark">New in v8.4.0</span> {#tidb-pre-split-regions-span-class-version-mark-new-in-v8-4-0-span}
...
### tidb_generate_binary_plan <span class="version-mark">New in v6.2.0</span> {#tidb-generate-binary-plan-span-class-version-mark-new-in-v6-2-0-span}
...
### tidb_gogc_tuner_max_value <span class="version-mark">New in v7.5.0</span> {#tidb-gogc-tuner-max-value-span-class-version-mark-new-in-v7-5-0-span}
...
### tidb_gogc_tuner_min_value <span class="version-mark">New in v7.5.0</span> {#tidb-gogc-tuner-min-value-span-class-version-mark-new-in-v7-5-0-span}
...
### tidb_gogc_tuner_threshold <span class="version-mark">New in v6.4.0</span> {#tidb-gogc-tuner-threshold-span-class-version-mark-new-in-v6-4-0-span}
...
### tidb_hash_join_version <span class="version-mark">New in v8.4.0</span> {#tidb-hash-join-version-span-class-version-mark-new-in-v8-4-0-span}
...
### tidb_historical_stats_duration <span class="version-mark">New in v6.6.0</span> {#tidb-historical-stats-duration-span-class-version-mark-new-in-v6-6-0-span}
...
### tidb_idle_transaction_timeout <span class="version-mark">New in v7.6.0</span> {#tidb-idle-transaction-timeout-span-class-version-mark-new-in-v7-6-0-span}
...
### tidb_ignore_inlist_plan_digest <span class="version-mark">New in v7.6.0</span> {#tidb-ignore-inlist-plan-digest-span-class-version-mark-new-in-v7-6-0-span}
...
### tidb_index_join_double_read_penalty_cost_rate <span class="version-mark">New in v6.6.0</span> {#tidb-index-join-double-read-penalty-cost-rate-span-class-version-mark-new-in-v6-6-0-span}
...
### tidb_index_merge_intersection_concurrency <span class="version-mark">New in v6.5.0</span> {#tidb-index-merge-intersection-concurrency-span-class-version-mark-new-in-v6-5-0-span}
...
### tidb_instance_plan_cache_reserved_percentage <span class="version-mark">New in v8.4.0</span> {#tidb-instance-plan-cache-reserved-percentage-span-class-version-mark-new-in-v8-4-0-span}
...
### tidb_instance_plan_cache_max_size <span class="version-mark">New in v8.4.0</span> {#tidb-instance-plan-cache-max-size-span-class-version-mark-new-in-v8-4-0-span}
...
### tidb_last_txn_info <span class="version-mark">New in v4.0.9</span> {#tidb-last-txn-info-span-class-version-mark-new-in-v4-0-9-span}
...
### tidb_last_plan_replayer_token <span class="version-mark">New in v6.3.0</span> {#tidb-last-plan-replayer-token-span-class-version-mark-new-in-v6-3-0-span}
...
### tidb_load_based_replica_read_threshold <span class="version-mark">New in v7.0.0</span> {#tidb-load-based-replica-read-threshold-span-class-version-mark-new-in-v7-0-0-span}
...
### <code>tidb_load_binding_timeout</code> <span class="version-mark">New in v8.0.0</span> {#code-tidb-load-binding-timeout-code-span-class-version-mark-new-in-v8-0-0-span}
...
### <code>tidb_lock_unchanged_keys</code> <span class="version-mark">New in v7.1.1 and v7.3.0</span> {#code-tidb-lock-unchanged-keys-code-span-class-version-mark-new-in-v7-1-1-and-v7-3-0-span}
...
### <code>tidb_low_resolution_tso_update_interval</code> <span class="version-mark">New in v8.0.0</span> {#code-tidb-low-resolution-tso-update-interval-code-span-class-version-mark-new-in-v8-0-0-span}
...
### tidb_max_auto_analyze_time <span class="version-mark">New in v6.1.0</span> {#tidb-max-auto-analyze-time-span-class-version-mark-new-in-v6-1-0-span}
...
### tidb_max_bytes_before_tiflash_external_group_by <span class="version-mark">New in v7.0.0</span> {#tidb-max-bytes-before-tiflash-external-group-by-span-class-version-mark-new-in-v7-0-0-span}
...
### tidb_max_bytes_before_tiflash_external_join <span class="version-mark">New in v7.0.0</span> {#tidb-max-bytes-before-tiflash-external-join-span-class-version-mark-new-in-v7-0-0-span}
...
### tidb_max_bytes_before_tiflash_external_sort <span class="version-mark">New in v7.0.0</span> {#tidb-max-bytes-before-tiflash-external-sort-span-class-version-mark-new-in-v7-0-0-span}
...
### tidb_max_paging_size <span class="version-mark">New in v6.3.0</span> {#tidb-max-paging-size-span-class-version-mark-new-in-v6-3-0-span}
...
### tidb_max_tiflash_threads <span class="version-mark">New in v6.1.0</span> {#tidb-max-tiflash-threads-span-class-version-mark-new-in-v6-1-0-span}
...
### tidb_memory_usage_alarm_keep_record_num <span class="version-mark">New in v6.4.0</span> {#tidb-memory-usage-alarm-keep-record-num-span-class-version-mark-new-in-v6-4-0-span}
...
### tidb_enable_async_merge_global_stats <span class="version-mark">New in v7.5.0</span> {#tidb-enable-async-merge-global-stats-span-class-version-mark-new-in-v7-5-0-span}
...
### tidb_min_paging_size <span class="version-mark">New in v6.2.0</span> {#tidb-min-paging-size-span-class-version-mark-new-in-v6-2-0-span}
...
### tidb_nontransactional_ignore_error <span class="version-mark">New in v6.1.0</span> {#tidb-nontransactional-ignore-error-span-class-version-mark-new-in-v6-1-0-span}
...
### tidb_slow_txn_log_threshold <span class="version-mark">New in v7.0.0</span> {#tidb-slow-txn-log-threshold-span-class-version-mark-new-in-v7-0-0-span}
