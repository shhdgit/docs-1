...
- 在 AWS 上，TiDB Cloud 提供 **TiDB Cloud Serverless**，适用于自动扩缩、成本高效的工作负载，以及 **TiDB Cloud Dedicated**，为企业级应用提供专属资源和高级能力。
- 在 Google Cloud 和 Azure 上，TiDB Cloud 提供 **TiDB Cloud Dedicated**，为企业级应用提供专属资源和高级能力。
- 在阿里云上，TiDB Cloud 提供 **TiDB Cloud Serverless**，适用于自动扩缩、成本高效的工作负载，以及 **TiDB Cloud Essential**，为具备生产能力的工作负载提供预配置容量。
