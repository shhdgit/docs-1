...
TiDB Cloud 的备份与恢复功能旨在保护你的数据安全，并通过支持集群数据的备份与恢复，确保业务连续性。
...
- [TiDB Cloud Serverless 和 TiDB Cloud Essential 集群的自动备份](/tidb-cloud/backup-and-restore-serverless.md#automatic-backups)
...
时点恢复是一项功能，允许你将任意时间点的数据恢复到一个新集群。你可以使用该功能：
...
- 对于 TiDB Cloud Serverless 集群，不支持时点恢复。
- 对于 TiDB Cloud Essential 集群，你可以恢复到最近 30 天内的任意时间点。更多信息，请参见 [恢复模式](/tidb-cloud/backup-and-restore-serverless.md#restore-mode)。
