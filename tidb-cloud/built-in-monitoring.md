...
1. 在项目的 [**Clusters**](https://tidbcloud.com/project/clusters) 页面，点击目标集群的名称，进入该集群的概览页面。
...
## TiDB Cloud Starter 和 Essential 集群的指标
...
| Average Query Duration | All, {SQL type} | 从客户端发送请求到 TiDB Cloud Starter 或 TiDB Cloud Essential 集群，直到集群执行请求并返回结果给客户端的持续时间。|
