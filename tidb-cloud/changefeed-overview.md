...
你可以通过扩容或缩容 changefeed 来调整其 TiCDC Replication Capacity Units（RCUs）。
...
关于 TiDB Cloud 中 changefeed 的计费方式，请参见 [Changefeed billing](/tidb-cloud/tidb-cloud-billing-ticdc-rcu.md)。
