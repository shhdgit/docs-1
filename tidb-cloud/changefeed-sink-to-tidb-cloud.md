...
- 源 TiDB Cloud Dedicated 集群和目标 TiDB Cloud Serverless 或 TiDB Cloud Essential 集群必须在同一个项目且同一区域。
...
5. 自定义 **Table Filter**，筛选你想要同步的表。规则语法可参考 [table filter rules](/table-filter.md)。
