...
> **注意：**
>
> 本文档适用于 [**TiDB Cloud Dedicated**](/tidb-cloud/select-cluster-tier.md#tidb-cloud-dedicated)。如果你需要为 **TiDB Cloud Serverless** 或 **TiDB Cloud Essential** 配置 IP 访问列表，请参见 [Configure TiDB Cloud Serverless or Essential Firewall Rules for Public Endpoints](/tidb-cloud/configure-serverless-firewall-rules-for-public-endpoints.md)。
