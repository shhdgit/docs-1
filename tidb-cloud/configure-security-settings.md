...
> **Note:**
>
> 对于 TiDB Cloud Serverless 或 TiDB Cloud Essential 集群，本文件不适用，你可以参考 [TLS Connection to TiDB Cloud Serverless or Essential](/tidb-cloud/secure-connections-to-serverless-clusters.md)。
