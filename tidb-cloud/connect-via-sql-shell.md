...
> **注意：**
>
> 你无法使用 SQL Shell 连接到 [TiDB Cloud Serverless](/tidb-cloud/select-cluster-tier.md#starter) 或 [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential)。如需连接到你的 TiDB Cloud Serverless 或 TiDB Cloud Essential 集群，请参阅 [Connect to TiDB Cloud Serverless or Essential Cluster](/tidb-cloud/connect-to-tidb-cluster-serverless.md)。
