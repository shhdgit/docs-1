...
> **注意：**
>
> 你无法使用 SQL Shell 连接到 [TiDB Cloud Serverless](/tidb-cloud/select-cluster-tier.md#tidb-cloud-serverless) 或 [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential)。如需连接到你的 TiDB Cloud Serverless 或 TiDB Cloud Essential 集群，请参阅 [Connect to TiDB Cloud Serverless or Essential Cluster](/tidb-cloud/connect-to-tidb-cluster-serverless.md)。

要通过 SQL shell 连接到你的 TiDB 集群，请按照以下步骤操作：
...
2. 点击目标集群的名称，进入该集群的概览页面，然后点击左侧导航栏的 **Settings** > **Networking**。
