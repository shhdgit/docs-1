...
> **Tip:**
>
> 如果你想了解如何通过公共连接接入 TiDB Cloud Serverless 或 TiDB Cloud Essential 集群，请参见 [Connect to TiDB Cloud Serverless or Essential via Public Endpoint](/tidb-cloud/connect-via-standard-connection-serverless.md)。
