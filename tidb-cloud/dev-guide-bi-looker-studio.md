...
1. 在 [**Clusters**](https://tidbcloud.com/project/clusters) 页面，点击你的 TiDB Cloud Serverless 集群名称，进入集群概览页。
...
3. 在 **BASIC** 设置面板中，配置连接参数。
    ...
    - **Enable SSL**：勾选该选项，然后点击 **MySQL SSL Client Configuration Files** 右侧的上传图标，上传在 [步骤 2](#step-2-get-the-connection-information-for-your-cluster) 下载的 CA 文件。
