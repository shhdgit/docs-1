...
>     - 按照 [连接到 TiDB Cloud Dedicated](/tidb-cloud/connect-via-standard-connection.md) 获取你的集群连接信息。连接 TiDB Cloud Dedicated 时，你需要允许来自 `142.251.74.0/23` 的访问。关于 Looker Studio 的连接详情，请参见 [Looker Studio documentation](https://support.google.com/looker-studio/answer/7088031#zippy=%2Cin-this-article)。
...
1. 在 [**Clusters**](https://tidbcloud.com/project/clusters) 页面，点击你的 TiDB Cloud Serverless 集群名称，进入其概览页面。
...
3. 在报告的工具栏中，点击 **Add a chart**，然后在 `Line` 分类下选择 `Combo chart`。
...
- 通过 [Looker Studio Help](https://support.google.com/looker-studio) 了解更多 Looker Studio 的用法。
