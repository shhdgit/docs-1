...
- 禁用 AI：在 [TiDB Cloud 控制台](https://tidbcloud.com/)左下角点击 <MDSvgIcon name="icon-top-account-settings" />，点击 **Account Settings**，进入 **AI & Privacy** 标签页，然后关闭 **AI-powered Data Exploration** 选项。
