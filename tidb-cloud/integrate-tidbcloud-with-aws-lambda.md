...
- AWS Lambda Function：处理请求并通过 Sequelize ORM 和 Fastify API 框架从 {} 集群查询数据。
...
为避免本地开发环境问题，推荐你使用云原生开发环境，如 [Gitpod](https://www.gitpod.io/)。
