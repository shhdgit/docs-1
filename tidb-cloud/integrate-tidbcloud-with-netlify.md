...
上文提到的示例应用运行在 Netlify 的无服务器函数上。本节将介绍如何将 [TiDB Cloud serverless 驱动](/tidb-cloud/serverless-driver.md) 与边缘函数一起使用。边缘函数是 Netlify 提供的一项功能，允许你在 Netlify CDN 的边缘运行无服务器函数。
