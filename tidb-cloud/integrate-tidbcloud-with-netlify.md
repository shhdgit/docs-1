...
starter 和 essential 集群默认允许所有 IP 地址连接，因此你无需配置任何流量过滤器。
...
3. 设置环境变量。为了让你自己的空间和 Netlify 空间都能连接到 TiDB Cloud 集群，你需要将 `DATABASE_URL` 设置为在 [第 1 步](#step-1-get-the-example-project-and-the-connection-string) 获取的连接字符串。
