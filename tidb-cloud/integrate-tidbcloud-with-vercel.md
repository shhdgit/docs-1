...
要通过 TiDB Cloud Vercel 集成连接，请前往 [TiDB Cloud 集成](https://vercel.com/integrations/tidb-cloud)页面（来自 [Vercel 的 Integrations Marketplace](https://vercel.com/integrations)）。使用此方法，你可以选择要连接的集群，TiDB Cloud 会自动为你的 Vercel 项目生成所有必要的环境变量。
...
这里以 Prisma 应用和 TiDB Cloud Serverless 集群为例，以下是 Prisma schema 文件中针对 TiDB Cloud Serverless 集群的数据源设置：
