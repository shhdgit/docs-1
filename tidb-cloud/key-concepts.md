...
TiDB Cloud Dedicated 支持你分别调整计算和存储资源，以适应数据量或工作负载的变化。[了解更多扩展性](/tidb-cloud/scalability-concepts.md)。

## 高可用

TiDB Cloud 在所有支持的方案中都确保高可用：
...
TiDB Cloud 提供全面的监控能力，用于集群性能和健康状况。[了解更多监控](/tidb-cloud/monitoring-concepts.md)。
