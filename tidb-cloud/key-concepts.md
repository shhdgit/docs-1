...
TiDB Cloud 允许你通过数据库、数据表、列、索引和约束等对象来组织和结构化你的数据。它还支持临时表、向量索引和缓存表等高级功能。[了解更多关于数据库模式](/tidb-cloud/database-schema-concepts.md)。
...
TiDB Cloud 的 AI 特性使你能够充分利用先进技术进行数据探索、搜索和集成。[了解更多关于 AI 特性](/tidb-cloud/ai-feature-concepts.md)。

## Data Service（Beta）

Data Service 允许你通过自定义 API 端点，以 HTTPS 请求方式访问 TiDB Cloud 数据。[了解更多关于 Data Service](/tidb-cloud/data-service-concepts.md)。
...
TiDB Cloud 提供全面的集群性能和健康状况监控能力。[了解更多关于监控](/tidb-cloud/monitoring-concepts.md)。
