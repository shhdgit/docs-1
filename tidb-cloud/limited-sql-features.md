...
[^1]: TiDB Cloud Serverless 与 TiDB Cloud Essential 不支持数据放置配置。
...
[^6]: 在 TiDB Cloud Serverless 或 TiDB Cloud Essential 上进行 [语句分析](/tidb-cloud/tune-performance.md#statement-analysis) 时，你可以使用 TiDB Cloud 控制台。
