...
|:-|:-|:-|
| `SLEEP` | 无限制 | [`SLEEP()` 函数](https://docs.pingcap.com/tidbcloud/miscellaneous-functions) 有限制，最大仅支持 300 秒的休眠时间。|
...
[^1]: TiDB Cloud Serverless 不支持数据副本配置。

[^2]: TiDB Cloud Serverless 不支持资源组配置。
