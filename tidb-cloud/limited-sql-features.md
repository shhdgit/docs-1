...
[^6]: 在 starter 或 essential 上进行 [SQL 语句分析](/tidb-cloud/tune-performance.md#statement-analysis) 时，你可以使用 TiDB Cloud 控制台。
