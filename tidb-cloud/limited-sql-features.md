...
[^1]: TiDB Cloud Serverless 与 TiDB Cloud Essential 不支持数据副本放置配置。

[^2]: TiDB Cloud Serverless 与 TiDB Cloud Essential 不支持资源组配置。
...
[^8]: TiDB Cloud Serverless 与 TiDB Cloud Essential 不支持插件。
