...
在访问 TiDB Cloud 之前，请先[创建一个 TiDB Cloud 账户](https://tidbcloud.com/free-trial)。你可以使用邮箱和密码注册，这样你可以[通过 TiDB Cloud 管理你的密码](/tidb-cloud/tidb-cloud-password-authentication.md)，也可以选择使用 Google、GitHub 或 Microsoft 账户进行单点登录（SSO）到 TiDB Cloud。
...
> **注意：**
>
> 邮件中的验证链接 24 小时内有效。如果你要邀请的用户未收到邮件，请点击 **Resend**。
...
> **注意：**
>
> 邮件中的验证链接 24 小时内有效。如果你的用户未收到邮件，请点击 **Resend**。
