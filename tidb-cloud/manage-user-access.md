...
8. 如果被邀请邮箱尚未注册 TiDB Cloud 账号，用户会跳转到注册页面创建账号；如果邮箱已注册 TiDB Cloud 账号，用户会跳转到登录页面，登录后账号会自动加入组织。
...
> **注意：**
>
> 当不在你组织内的用户加入你的项目时，该用户也会自动加入你的组织。
...
8. 如果被邀请邮箱尚未注册 TiDB Cloud 账号，用户会跳转到注册页面创建账号；如果邮箱已注册 TiDB Cloud 账号，用户会跳转到登录页面。登录后账号会自动加入项目。
