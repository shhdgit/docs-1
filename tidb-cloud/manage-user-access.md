...
| 编辑组织的支付信息。 | ✅ | ✅ | ❌ | ❌ | ❌ |
| 查看账单并使用 [cost explorer](/tidb-cloud/tidb-cloud-billing.md#cost-explorer)。 | ✅ | ✅ | ✅ | ❌ | ❌ |
...
| 管理项目下 TiDB Cloud Serverless 和 TiDB Cloud Essential 集群的分支，如分支创建、连接和删除。 | ✅ | ❌ | ❌ | ❌ |
| 管理项目下 TiDB Cloud Dedicated 集群的 [恢复组](/tidb-cloud/recovery-group-overview.md)，如恢复组创建和删除。 | ✅ | ❌ | ❌ | ❌ |
...
1. 在 [TiDB Cloud 控制台](https://tidbcloud.com)中，点击左上角的下拉框。会显示你所属的组织和项目列表。
    ...
    > - 如果你属于多个组织，可以在下拉框中点击目标组织名称，在组织间切换账号。
...
8. 如果被邀请邮箱尚未注册 TiDB Cloud 账号，用户会被引导至注册页面创建账号；如果邮箱已注册 TiDB Cloud 账号，用户会被引导至登录页面，登录后账号会自动加入组织。

> **注意：**
>
> 邮件中的验证链接 24 小时内有效。如果你邀请的用户未收到邮件，可点击 **Resend** 重新发送。
...
1. 在 [TiDB Cloud 控制台](https://tidbcloud.com)中，点击左上角的下拉框。会显示你所属的组织和项目列表。
    ...
    >
    > - 如果你当前在某个集群页面，点击左上角下拉框后，还需要点击下拉框中的 ← 返回到组织和项目列表。
    > - 如果你属于多个项目，可以在下拉框中点击目标项目名称，在项目间切换。
...
8. 如果被邀请邮箱尚未注册 TiDB Cloud 账号，用户会被引导至注册页面创建账号；如果邮箱已注册 TiDB Cloud 账号，用户会被引导至登录页面。登录后账号会自动加入项目。
