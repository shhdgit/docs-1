...
在访问 TiDB Cloud 之前，请先[创建一个 TiDB Cloud 账号](https://tidbcloud.com/free-trial)。你可以使用邮箱和密码注册，这样你可以[通过 TiDB Cloud 管理你的密码](/tidb-cloud/tidb-cloud-password-authentication.md)，也可以选择使用 Google、GitHub 或 Microsoft 账号进行单点登录（SSO）到 TiDB Cloud。
...
| 管理项目中 TiDB Cloud Starter 和 TiDB Cloud Essential 集群的分支，如分支创建、连接和删除。 | ✅ | ❌ | ❌ | ❌ |
