...
本文档描述了如何通过分步示例，使用 AWS 数据库迁移服务（AWS DMS）将数据从 Amazon RDS for Oracle 迁移到 [{{{ .starter }}}](https://tidbcloud.com/clusters/create-cluster)。
...
> **注意：**
>
> 有关创建 AWS DMS 复制实例以配合 {{{ .starter }}} 使用的详细步骤，请参阅 [连接 AWS DMS 到 TiDB Cloud 集群](/tidb-cloud/tidb-cloud-connect-aws-dms.md)。
