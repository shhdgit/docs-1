---
title: 监控
summary: 了解 TiDB Cloud 的监控相关概念。
---

# 监控

TiDB Cloud 的监控为你提供了工具和集成方案，使你能够监控集群性能、跟踪活动，并及时响应问题。

## 内置指标

内置指标是指 TiDB Cloud 收集并在 **Metrics** 页面展示的集群标准指标全套。通过这些指标，你可以轻松识别性能问题，并判断当前的数据库部署是否满足你的需求。
...
- [Datadog 集成](/tidb-cloud/monitor-datadog-integration.md)

- [Prometheus 和 Grafana 集成（Beta）](/tidb-cloud/monitor-prometheus-and-grafana-integration.md)

- [New Relic 集成](/tidb-cloud/monitor-new-relic-integration.md)