...
> **注意：**
>
> 你无法暂停 [TiDB Cloud Serverless](/tidb-cloud/select-cluster-tier.md#starter) 或 [TiDB Cloud Essential](/tidb-cloud/select-cluster-tier.md#essential) 集群。
...
- 如果集群存在任何 [changefeeds](/tidb-cloud/changefeed-overview.md)，则无法暂停集群。你需要[删除现有的 changefeeds](/tidb-cloud/changefeed-overview.md#delete-a-changefeed) 后才能暂停集群。
