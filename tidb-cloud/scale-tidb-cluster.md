...
> **Note:**
>
> 如果 TiDB 或 TiKV 的 vCPU 和内存配置为 **4 vCPU, 16 GiB**，请注意以下限制。要绕过这些限制，你可以先 [增加 vCPU 和内存](#change-vcpu-and-ram)。
>
...
2. 在你想要扩容的集群所在行，点击 **...**。
    ...
    > **Tip:**
    >
    > 你也可以在 **Clusters** 页面点击你想要扩容的集群名称，然后点击右上角的 **...**。
...
> - 在减少 vCPU 之前，请确保 TiKV 或 TiFlash 当前节点的存储未超过目标 vCPU 的最大节点存储。详情请参见 [TiKV 节点存储](/tidb-cloud/size-your-cluster.md#tikv-node-storage-size) 和 [TiFlash 节点存储](/tidb-cloud/size-your-cluster.md#tiflash-node-storage)。如果任一组件当前存储超过其限制，则无法减少 vCPU。
