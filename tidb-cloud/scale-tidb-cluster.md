...
关于如何确定你的 TiDB 集群规格，请参见 [确定你的 TiDB 规格](/tidb-cloud/size-your-cluster.md)。

> **Note:**
>
> 如果 TiDB 或 TiKV 的 vCPU 和内存规格设置为 **4 vCPU, 16 GiB**，请注意以下限制。要绕过这些限制，你可以先[增加 vCPU 和内存](#change-vcpu-and-ram)。
>
...
3. 在下拉菜单中点击 **Modify**。会显示 **Modify Cluster** 页面。
4. 在 **Modify Cluster** 页面，更改 TiDB、TiKV 或 TiFlash 的节点数量。
5. 在右侧面板检查集群规格，然后点击 **Confirm**。
