...
> **注意：**
>
> 如果 TiDB 或 TiKV 的 vCPU 和内存规格设置为 **4 vCPU, 16 GiB**，请注意以下限制。你可以先[提升 vCPU 和内存](#change-vcpu-and-ram)以绕过这些限制。
>
...
>
> - 更改 vCPU 和内存仅适用于以下集群：
>     - 部署在 AWS 且创建时间为 2022/12/31 之后。
>     - 部署在 Google Cloud 且创建时间为 2023/04/26 之后。
>     - 部署在 Azure 上。
