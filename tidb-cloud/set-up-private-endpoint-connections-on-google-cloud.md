...
> **Tip:**
>
> - 如果你想了解如何通过 AWS 私有端点连接 TiDB Cloud 专属集群，请参见 [通过 AWS PrivateLink 连接 TiDB Cloud 专属集群](/tidb-cloud/set-up-private-endpoint-connections.md)。
> - 如果你想了解如何通过 Azure 私有端点连接 TiDB Cloud 专属集群，请参见 [通过 Azure Private Link 连接 TiDB Cloud 专属集群](/tidb-cloud/set-up-private-endpoint-connections-on-azure.md)。
> - 如果你想了解如何通过私有端点连接 {{{ .starter }}} 或 {{{ .essential }}} 集群，请参见以下文档：
...
而直接复制 service attachment（即未通过 TiDB Cloud 控制台生成的命令创建的端点）生成的端点不会在 TiDB Cloud 控制台显示。
