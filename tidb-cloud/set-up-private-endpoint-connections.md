...
> **Tip:**
>
> - 如果你想了解如何通过 AWS PrivateLink 连接到 TiDB Cloud Serverless 或 TiDB Cloud Essential 集群，请参见 [Connect to TiDB Cloud Serverless or Essential via AWS PrivateLink](/tidb-cloud/set-up-private-endpoint-connections-serverless.md)。
...
> **Tip:**
>
> 如果无法连接到集群，可能是因为你在 AWS 中的 VPC 终端节点的安全组设置不正确。解决方法请参见 [此 FAQ](#troubleshooting)。
