...
1. 在你的 [AWS 管理控制台](https://console.aws.amazon.com/) 中确认接受对等连接请求。
    ...
    2. 在左侧导航栏，打开 **Peering Connections** 页面。在 **Create Peering Connection** 标签页下，某个 Peering 连接处于 **Pending Acceptance** 状态。
