...
2. 根据你的账户信息配置 AWS CLI。关于 AWS CLI 所需信息，请参见 [AWS CLI 配置基础](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-quickstart.html)。
...
你也可以使用 AWS 控制台来配置 VPC Peering 连接。
