...
[Terraform](https://www.terraform.io/) 是一款基础设施即代码（Infrastructure as Code，IaC）工具，可以让你通过可读性强的配置文件来定义云端和自托管资源，并支持版本管理、复用和共享。

[TiDB Cloud Terraform Provider](https://registry.terraform.io/providers/tidbcloud/tidbcloud) 是一个插件，允许你使用 Terraform 来管理 TiDB Cloud 资源，例如集群、备份和恢复等。
...
[资源（Resources）](https://www.terraform.io/language/resources) 和 [数据源（Data sources）](https://www.terraform.io/language/data-sources) 是 Terraform 语言中最重要的两个元素。
...
如需获取所有资源和数据源的可用配置，请参见此 [配置文档](https://registry.terraform.io/providers/tidbcloud/tidbcloud/latest/docs)。
