...
2. 创建一个 `vpc_peering.tf` 文件：
    ...
    - 如需获取 TiDB Cloud Dedicated VPC Peering 的规格信息，请参见 [tidbcloud_dedicated_vpc_peering (Resource)](https://registry.terraform.io/providers/tidbcloud/tidbcloud/latest/docs/resources/dedicated_vpc_peering)。
